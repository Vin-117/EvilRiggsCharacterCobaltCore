...
public class EvilRiggsEngineRedirectManager : IKokoroApi.IV2.IStatusLogicApi.IHook, IKokoroApi.IV2.IStatusRenderingApi.IHook
{

    public EvilRiggsEngineRedirectManager()
    {
    ...
    private static Status EvilRiggsEngineRedirect => ModEntry.Instance.EvilRiggsEngineRedirect.Status;
    ...
    public bool HandleStatusTurnAutoStep(IHandleStatusTurnAutoStepArgs args)
    {
        ...
        if (args.Status != EvilRiggsEngineRedirect)
            return false;
